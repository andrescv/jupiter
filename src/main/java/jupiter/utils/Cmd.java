...
public final class Cmd {
  ...
  /**
   * Prints Jupiter help message and exit.
   *
   * @param force if true force print
   */
  private static void help(boolean force) {
    if (force || Flags.HELP) {
      title(true, false);
      IO.stdout().println("usage: jupiter [options] <files>");
      IO.stdout().println(Data.EOL + "[General Options]");
      IO.stdout().println("  -h, --help               show Jupiter help message and exit");
      IO.stdout().println("  -v, --version            show Jupiter version");
      IO.stdout().println("  -l, --license            show Jupiter license");
      ...
      IO.stdout().println();
      IO.stdout().println("Please report issues at https://github.com/andrescv/Jupiter/issues");
      // exit simulator
      if (Flags.HELP) {
        Jupiter.exit(0);
      } else {
