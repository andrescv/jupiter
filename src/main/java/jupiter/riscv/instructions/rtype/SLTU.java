...
public final class SLTU extends Instruction {

  /** Creates a new sltu instruction. */
  public SLTU() {
    super(Format.R, "sltu", 0b0110011, 0b011, 0b0000000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.xregfile().setRegister(code.get(InstructionField.RD), (Integer.compareUnsigned(rs1, rs2) < 0) ? 1 : 0);
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("sltu x%d, x%d, x%d", rd, rs1, rs2);
  }
