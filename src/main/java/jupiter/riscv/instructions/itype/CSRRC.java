...
/** RISC-V csrrc (Control and Status Register Read and Clear) instruction. */
public final class CSRRC extends Instruction {

  /** Creates a new csrrc instruction. */
  public CSRRC() {
    super(Format.I, "csrrc", 0b1110011, 0b011, 0b0000000);
  }
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("csrrc x%d, %d, x%d", rd, csr, rs1);
  }
