...
/** RISC-V addi (Add Immediate) instruction. */
public final class ADDI extends Instruction {

  /** Creates a new addi instruction. */
  public ADDI() {
    super(Format.I, "addi", 0b0010011, 0b000, 0b0000000);
  }
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("addi x%d, x%d, %d", rd, rs1, imm);
  }
