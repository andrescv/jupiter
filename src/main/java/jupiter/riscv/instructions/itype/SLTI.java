...
public final class SLTI extends Instruction {

  /** Creates a new slti instruction. */
  public SLTI() {
    super(Format.I, "slti", 0b0010011, 0b010, 0b0000000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.xregfile().setRegister(code.get(InstructionField.RD), (rs1 < Data.imm(code, Format.I)) ? 1 : 0);
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("slti x%d, x%d, %d", rd, rs1, imm);
  }
