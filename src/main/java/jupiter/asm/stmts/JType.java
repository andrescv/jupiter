...
package jupiter.asm.stmts;

import java.io.File;

import jupiter.Globals;
import jupiter.asm.Relocation;
import jupiter.exc.AssemblerException;
import jupiter.exc.RelocationException;
...
public final class JType extends Statement {
   ...
   */
  public JType(File file, int line, String mnemonic, int rd, Object offset) {
