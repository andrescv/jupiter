...
public final class Icons {
   ...
   *
   * @return Jupiter favicon image.
   */
  public static Image favicon() {
    return new Image(Icons.class.getResourceAsStream("/jupiter/img/favicon.png"));
  }
  ...
  public static ImageView about() {
    ...
    img.setFitWidth(500);
    img.setImage(new Image(Icons.class.getResourceAsStream("/jupiter/img/about.png")));
    return img;
  }
  ...
  public static ImageView btn(String name, double width, double height) {
    ...
    img.setFitWidth(width);
    img.setFitHeight(height);
    img.setImage(new Image(Icons.class.getResourceAsStream(String.format("/jupiter/img/icons/btns/%s.png", name))));
    return img;
  }
