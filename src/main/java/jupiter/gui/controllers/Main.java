...
import jupiter.gui.dialogs.*;
import jupiter.utils.IO;
import jupiter.utils.io.GUIConsoleInput;
import jupiter.utils.io.GUIConsoleOutput;


/** Jupiter GUI main controller. */
public final class Main implements Initializable {
  ...
  /**
   * Returns Jupiter directory chooser dialog.
   *
  ...
  /**
   * Returns Jupiter file chooser dialog.
   *
