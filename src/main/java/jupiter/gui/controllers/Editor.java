...
import jupiter.gui.DirWatcher;
import jupiter.gui.Icons;
import jupiter.gui.Settings;
import jupiter.gui.components.EditorTab;
import jupiter.gui.components.TreeFileItem;
import jupiter.gui.dialogs.FindReplaceDialog;
import jupiter.utils.FS;


/** Jupiter GUI editor controller. */
public final class Editor implements PropertyChangeListener {
  ...
  /**
   * Initializes Jupiter's GUI editor controller.
   *
