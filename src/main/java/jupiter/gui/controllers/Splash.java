...
/** Jupiter GUI splash screen controller. */
    ...
    Thread th = new Thread(new Task<Void>() {
      ...
      public Void call() {
        ...
        Platform.runLater(() -> {
          try {
            // load file
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/jupiter/fxml/Main.fxml"));
            ...
            scene.setRoot(root);
            // set styles
            scene.getStylesheets().addAll(getClass().getResource("/jupiter/css/jupiter.css").toExternalForm());
          } catch (IOException e) {
