...
import jvpiter.gui.dialogs.*;
import jvpiter.utils.IO;
import jvpiter.utils.io.GUIConsoleInput;
import jvpiter.utils.io.GUIConsoleOutput;


/** Jvpiter GUI main controller. */
public final class Main implements Initializable {
  ...
  /**
   * Returns Jvpiter directory chooser dialog.
   *
  ...
  /**
   * Returns Jvpiter file chooser dialog.
   *
