...
/** Jvpiter GUI splash screen controller. */
    ...
    Thread th = new Thread(new Task<Void>() {
      ...
      public Void call() {
        ...
        Platform.runLater(() -> {
          try {
            // load file
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/jvpiter/fxml/Main.fxml"));
            ...
            scene.setRoot(root);
            // set styles
            scene.getStylesheets().addAll(getClass().getResource("/jvpiter/css/jvpiter.css").toExternalForm());
          } catch (IOException e) {
            Logger.error("could not load Jvpiter GUI");
            Jvpiter.exit(1);
          }
        });
        // wait a little bit
