...
package jvpiter.riscv.instructions.r4type;
...
/** RISC-V fmadd.s (Floating-point Fused Multiply-Add, Single-Precision) instruction. */
public final class FMADDS extends Instruction {

  /** Creates a new fmadd.s instruction. */
  public FMADDS() {
    super(Format.R4, "fmadd.s", 0b1000011, 0b111, 0b0000000);
  }
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("fmadd.s f%d, f%d, f%d, f%d", rd, rs1, rs2, rs3);
  }
