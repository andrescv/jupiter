...
public final class SRAI extends Instruction {

  /** Creates a new srai instruction. */
  public SRAI() {
    super(Format.I, "srai", 0b0010011, 0b101, 0b0100000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.xregfile().setRegister(code.get(InstructionField.RD), rs1 >> (Data.imm(code, Format.I) & 0x1f));
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("srai x%d, x%d, %d", rd, rs1, imm);
  }
