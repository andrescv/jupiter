...
public final class LH extends Instruction {

  /** Creates a new lh instruction. */
  public LH() {
    super(Format.I, "lh", 0b0000011, 0b001, 0b0000000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.xregfile().setRegister(code.get(InstructionField.RD), state.memory().loadHalf(addr));
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("lh x%d, x%d, %d", rd, rs1, imm);
  }
