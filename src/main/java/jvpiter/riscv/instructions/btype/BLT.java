...
/** RISC-V blt (Branch if Less Than) instruction. */
public final class BLT extends Instruction {

  /** Creates a new blt instruction. */
  public BLT() {
    super(Format.B, "blt", 0b1100011, 0b100, 0b0000000);
  }
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("blt x%d, x%d, %d", rs1, rs2, imm);
  }
