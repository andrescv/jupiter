...
public final class SLT extends Instruction {

  /** Creates a new slt instruction. */
  public SLT() {
    super(Format.R, "slt", 0b0110011, 0b010, 0b0000000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.xregfile().setRegister(code.get(InstructionField.RD), (rs1 < rs2) ? 1 : 0);
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("slt x%d, x%d, x%d", rd, rs1, rs2);
  }
