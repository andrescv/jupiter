...
/** RISC-V sll (Shift Left Logical) instruction. */
public final class SLL extends Instruction {

  /** Creates a new sll instruction. */
  public SLL() {
    super(Format.R, "sll", 0b0110011, 0b001, 0b0000000);
  }
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("sll x%d, x%d, x%d", rd, rs1, rs2);
  }
