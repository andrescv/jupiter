...
import jvpiter.asm.stmts.*;
import jvpiter.riscv.instructions.*;
...
public final class InstructionSet {
  ...
  private void populate() {
    try {
      BufferedReader br = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/jvpiter/all.txt")));
      String line = "";
      String pkg = "";
      ...
      br.close();
      // add pseudos
      br = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/jvpiter/pseudos.txt")));
      line = "";
      while ((line = br.readLine()) != null) {
        line = line.trim();
        if (!line.equals("")) {
