...
public final class SH extends Instruction {

  /** Creates a new sh instruction. */
  public SH() {
    super(Format.S, "sh", 0b0100011, 0b001, 0b0000000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.memory().storeHalf(rs1 + Data.imm(code, Format.S), rs2);
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("sh x%d, x%d, %d", rs1, rs2, imm);
  }
