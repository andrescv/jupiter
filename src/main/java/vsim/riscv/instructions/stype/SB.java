...
/** RISC-V sb (Store Byte) instruction. */
public final class SB extends Instruction {

  /** Creates a new sb instruction. */
  public SB() {
    super(Format.S, "sb", 0b0100011, 0b000, 0b0000000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.memory().storeByte(rs1 + Data.imm(code, Format.S), rs2);
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("sb x%d, x%d, %d", rs1, rs2, imm);
  }
