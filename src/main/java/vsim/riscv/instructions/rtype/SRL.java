...
/** Creates a new srl (Shift Right Logical) instruction. */
public final class SRL extends Instruction {

  /** Creates a new srl instruction. */
  public SRL() {
    super(Format.R, "srl", 0b0110011, 0b101, 0b0000000);
  }
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("srl x%d, x%d, x%d", rd, rs1, rs2);
  }
