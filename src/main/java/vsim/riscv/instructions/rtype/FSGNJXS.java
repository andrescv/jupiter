...
public final class FSGNJXS extends Instruction {

  /** Creates a new fsgnjx.s instruction. */
  public FSGNJXS() {
    super(Format.R, "fsgnjx.s", 0b1010011, 0b010, 0b0010000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.fregfile().setRegister(code.get(InstructionField.RD), Float.intBitsToFloat(sign | cx));
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("fsgnjx.s f%d, f%d, f%d", rd, rs1, rs2);
  }
