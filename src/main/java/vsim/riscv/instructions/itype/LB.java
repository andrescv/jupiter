...
public final class LB extends Instruction {

  /** Creates a new lb instruction. */
  public LB() {
    super(Format.I, "lb", 0b0000011, 0b000, 0b0000000);
  }
  ...
  public void execute(MachineCode code, State state) throws SimulationException {
    ...
    state.xregfile().setRegister(code.get(InstructionField.RD), state.memory().loadByte(addr));
  ...
  public String disassemble(MachineCode code) {
    ...
    return String.format("lb x%d, x%d, %d", rd, rs1, imm);
  }
